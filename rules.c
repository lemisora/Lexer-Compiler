...
char *yytext;
#line 1 "rules.l"
/*Se necesita que el analizador lexico cumpla con los siguientes requisitos:
//- Reconozca los identificadores comunes
//- Numeros enteros y reales
//- Palabras reservadas: while, when
//- Asignacion '='
//- Operadores: +, -, *, /, ++, --
//- Relación: >,<,>=,<=, <>
- Agrupación: (,),[,] */
...
YY_RULE_SETUP
#line 19 "rules.l"
{ printf("Se ha encontrado un entero: %s (%d)\n", yytext, atoi(yytext) );}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 21 "rules.l"
